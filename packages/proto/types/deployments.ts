...
export interface DeploymentsServiceController {
  getAllProjects(request: UserId): Promise<Project> | Observable<Project> | Project;

  createDeployment(request: CreateDeploymentDto): Promise<Projects> | Observable<Projects> | Projects;

  getDeployments(request: GetDeploymentDto): Promise<Deployments> | Observable<Deployments> | Deployments;
  ...
  updateAndRedeploy(request: UpdateDeploymentDto): Promise<Deployment> | Observable<Deployment> | Deployment;
}
